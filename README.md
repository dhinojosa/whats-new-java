...
* Introduction
    ...
    * Do you program with Ai now?
* Installation and Management of Java: Manual Installation, SDKMan.io, `jenv`, nix
...
* [JDK 23](https://docs.oracle.com/en/java/javase/23/docs/api/)
    ...
    * Module Import Declarations (Preview) [JEP 476](https://openjdk.org/jeps/476)
    * Markdown Documentation Comments [JEP 467](https://openjdk.org/jeps/467)
* [JDK 24](https://docs.oracle.com/en/java/javase/24/docs/api/)
...
* [JDK 25](https://docs.oracle.com/en/java/javase/25/docs/api/)
...
* [JDK 26](https://docs.oracle.com/en/java/javase/26/docs/api/)
    * Primitive Types in Patterns, `instanceof`, and `switch` (Fourth Preview) [JEP 530](https://openjdk.org/jeps/530)
    * Vector API (Eleventh Incubator) [JEP 529](https://openjdk.org/jeps/529)
    * Lazy Constants (Second Preview) Lazy Constants [JEP 526](https://openjdk.org/jeps/526)
    * Structured Concurrency (Sixth Preview) Structured Concurrency [JEP 525](https://openjdk.org/jeps/525)
